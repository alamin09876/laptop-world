                ...
                <div className="navbar-end ">
                    {
                        user?.uid ?
                            <>
                                {
                                    isAdmin === 'admin' ? <button ><Link to='/allusers' className='lg:mr-6 hidden lg:flex'>All users</Link></button> : <></>
                                }

                                <button ><Link to="/myorders" className='lg:mr-6 hidden lg:flex'>My Orders</Link></button>
